...
window.addEventListener("click",scrollEvent,{passive:false});window.addEventListener("touchstart",scrollEvent,{passive:false});window.addEventListener("touchmove",scrollEvent,{passive:false});